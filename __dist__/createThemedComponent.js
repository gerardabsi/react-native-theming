...
{var _props=
this.props,style=_props.style,children=_props.children,other=_objectWithoutProperties(_props,['style','children']);var _state2=
this.state,theme=_state2.theme,props=_state2.props;

var themedStyle=theme.getStyle(style);

return(
_react2.default.createElement(C,_extends({style:themedStyle},other,props,{__source:{fileName:_jsxFileName,lineNumber:92}}),
children));
